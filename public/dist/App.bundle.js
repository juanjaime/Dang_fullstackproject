...
function autocomplete(input, latInput, lngInput) {
	...
	input.on('keydown', function (e) {
		if (e.keCode === 13) e.preventDefault();
	});
}
...
var mapOptions = {
    center: { lat: 43.257, lng: -79.87 },
    zoom: 10
};
function loadPlaces(map) {
    var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 43.257;
    var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -79.87;
